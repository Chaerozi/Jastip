  ...
  return (
    <Section className="bg-muted/30">
      <SectionHeader
        ...
        description="Koleksi produk terbaru yang baru saja hadir"
        action={{ label: 'Lihat Semua', href: '/products?new=true' }}
      />
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4 lg:gap-6">
          {Array.from({ length: 4 }).map((_, index) => (
            <div key={index} className="group overflow-hidden rounded-lg border bg-card">
              ...
              <div className="p-3">
                <p className="truncate text-sm font-medium">Produk Terbaru</p>
